...
public class StaminaBar : MonoBehaviour
{
	...
	private RectTransform stamina;
	private float staminaMax, presentStamina;
	private float staminaMaxSize, presentStaminaSize;

	private void Awake()
	{
		stamina = transform.GetChild(1).GetComponent<RectTransform>();
	}
	private void Start()
	{
		stamina.sizeDelta = GetComponent<RectTransform>().sizeDelta + new Vector2(-20, 0);

		staminaMaxSize = stamina.sizeDelta.x;
		presentStamina = staminaMaxSize;
